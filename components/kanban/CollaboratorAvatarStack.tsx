        ...
        {visibleUsers.map((user, index) => (
          ...
          >
            ...
            {hoveredUser === user.userId && (
              <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-3 py-2 bg-gray-900 text-white text-xs rounded-lg shadow-lg whitespace-nowrap z-50 pointer-events-none">
