...
const KanbanBoard = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 h-full flex flex-col">
      <div className="py-6 overflow-visible flex-shrink-0" style={{ marginLeft: '2rem', marginRight: '2rem' }}>
        ...
        {/* Columns Grid */}
        <div className="overflow-x-auto overflow-y-visible pb-4 flex-1">
